...
<html>
  ...
  <body>
  <%
    String clientId = "UC3220rQjywXMHJ12RyK";//애플리케이션 클라이언트 아이디값";
    String clientSecret = "VTo6KBkEuu";//애플리케이션 클라이언트 시크릿값";
