...
<body>
<%
	String path = request.getRealPath("media");/////이거씀
	int size = 1024*1024*2; //2MB/////이거씀
	...
	String fileName = multi.getFilesystemName("userProfile");	//정책에 의해서 변경된 이름/////이거씀
	String originFileName=multi.getOriginalFileName("userProfile");//원래 파일 이름
	String contextPath = getServletContext().getContextPath();	/////이거씀
	String downloadPath = getServletContext().getRealPath("media");
	
	String filePath = contextPath+"/media/"+fileName;	/////이거씀
%>
